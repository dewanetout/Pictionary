var pictionary = function() {
    ...
    var WORDS = ["voiture","fleur","maison", "nuage", "arbre", "ampoule", "gsm", "chaussure", "vaisselle", "pied", "ballon",
    ...
    "oeil","banane","vache","marteau","tortue","bras","cd","moto","sucette","soleil"
    ];
    ...
    canvas.on('mousemove', function(event) {
        if (userType | artist) {
            if (drawing) {
                console.log('in mouse move1')
                var offset = canvas.offset();
                var position = {
                    x: event.pageX - offset.left,
                    y: event.pageY - offset.top
                };
                console.log('in mouse move2')
                draw(position);
                console.log('in mouse move3')
